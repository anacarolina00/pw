    ...
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">Ana Carolina</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="https://github.com/anacarolina00" class="github"><i class="bx bxl-github"></i></a>
          <a href="https://www.youtube.com/channel/UCz_LKgmtgUoog6VnQf0IyWw?view_as=subscriber" class="youtube">
            <i class="bx bxl-youtube"></i></a>
          <a href="https://www.linkedin.com/in/ana-carolina-65b0b81b4" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
